...
class OpenAIModelTests extends TestCase
{
	...
	{
		echo "Test 1: Test chat uses default model when no model option supplied\n";
	...
	{
		echo "Test 2: Test chat overrides default model when explicit model provided\n";
	...
	{
		echo "Test 3: Test generateImage uses method default after unsetting provider default\n";
