...
class EmbeddingTests extends TestCase
{
	...
	{
		echo "Test 1: Test createEmbeddings returns float embedding successfully\n";
	...
	{
		echo "Test 2: Test createEmbeddings returns multiple base64 vectors\n";
	...
	{
		echo "Test 3: Test createEmbeddings raises InvalidArgumentException on invalid model\n";
	...
	{
		echo "Test 4: Test createEmbeddings raises InvalidArgumentException on invalid encoding format\n";
	...
	{
		echo "Test 5: Test createEmbeddings raises ProviderException on provider error\n";
	...
	{
		echo "Test 6: Test createEmbeddings raises UnserializableResponseException on invalid JSON\n";
	...
	{
		echo "Test 7: Test createEmbeddings raises Exception when moderation flags content\n";
