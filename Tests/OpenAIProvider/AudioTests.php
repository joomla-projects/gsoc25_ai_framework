...
class OpenAIAudioTest extends TestCase
{
	...
	{
		echo "Test 1: Test speech method for successful completion\n";
	...
	{
		echo "Test 2: Test speech method raises InvalidArgumentException on invalid voice\n";
	...
	{
		echo "Test 3: Test transcribe method for successful completion\n";
	...
	{
		echo "Test 4: Test transcribe method raises InvalidArgumentException on invalid response format\n";
	...
	{
		echo "Test 5: Test translate method for successful completion\n";
	...
	{
		echo "Test 6: Test translate method raises ProviderException on server error\n";
	...
	{
		echo "Test 7: Test translate method raises UnserializableResponseException on invalid JSON\n";
